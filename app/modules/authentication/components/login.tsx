    ...
    <div className="w-screen h-screen flex items-center justify-center bg-linear-to-bl from-violet-300 to-fuchsia-300">
      <Card className="w-full max-w-md">
        ...
        <CardHeader>
          ...
          <CardDescription>
            Welcome to the Beta National Tutoring Observatory Pipeline tool! This application is designed to help researchers and product teams analyze tutoring data efficiently.
            <br /><br />
        ...
        <CardFooter className="flex-row gap-2">
          ...
          <Button variant="outline" className="w-1/2 cursor-pointer" onClick={onLoginWithGithubClicked}>
            <svg width="24px" height="24px" className="scale-120" strokeWidth="1.5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="#000000"><path d="M12 22C17.5228 22 22 17.5228 22 12C22 6.47715 17.5228 2 12 2C6.47715 2 2 6.47715 2 12C2 17.5228 6.47715 22 12 22Z" stroke="#000000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path><path d="M14.3333 19V17.137C14.3583 16.8275 14.3154 16.5163 14.2073 16.2242C14.0993 15.9321 13.9286 15.6657 13.7067 15.4428C15.8 15.2156 18 14.4431 18 10.8989C17.9998 9.99256 17.6418 9.12101 17 8.46461C17.3039 7.67171 17.2824 6.79528 16.94 6.01739C16.94 6.01739 16.1533 5.7902 14.3333 6.97811C12.8053 6.57488 11.1947 6.57488 9.66666 6.97811C7.84666 5.7902 7.05999 6.01739 7.05999 6.01739C6.71757 6.79528 6.69609 7.67171 6.99999 8.46461C6.35341 9.12588 5.99501 10.0053 5.99999 10.9183C5.99999 14.4366 8.19999 15.2091 10.2933 15.4622C10.074 15.6829 9.90483 15.9461 9.79686 16.2347C9.68889 16.5232 9.64453 16.8306 9.66666 17.137V19" stroke="#000000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path><path d="M9.66667 17.7018C7.66667 18.3335 6 17.7018 5 15.7544" stroke="#000000" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path></svg>
            Login with Github
          </Button>
          <Button variant="outline" className="w-1/2" asChild>
            <a href="https://docs.google.com/forms/d/e/1FAIpQLSdCvn_LMyj7fV2ITrvp-0AEgmTzziWC1b7s14TaNLySLL7avw/viewform" target="_blank">
              <ExternalLink />
