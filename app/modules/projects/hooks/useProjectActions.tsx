...
export function useProjectActions({
  ...
  useEffect(() => {
    if (editFetcher.state === 'idle' && editFetcher.data) {
      if (editFetcher.data.success && editFetcher.data.intent === 'UPDATE_PROJECT') {
  ...
  useEffect(() => {
    if (deleteFetcher.state === 'idle' && deleteFetcher.data) {
      if (deleteFetcher.data.success && deleteFetcher.data.intent === 'DELETE_PROJECT') {
