...
const CreateRunSetDialog = ({
  onCreateNewRunSetClicked,
}: {
  onCreateNewRunSetClicked: ({ name }: { name: string }) => void;
}) => {
  ...
  return (
    <DialogContent>
      <DialogHeader>
        <DialogTitle>Create a new run set</DialogTitle>
        <DialogDescription>
...
export default CreateRunSetDialog;
