  ...
  return (
    <DialogContent>
      <DialogHeader>
        ...
        <DialogDescription>
          Give your team a name. This can be changed at a later date but giving a description now will make it easier to find later.
        </DialogDescription>
      </DialogHeader>
      <div className="grid gap-3">
        <Label htmlFor="name-1">Name</Label>
        <Input id="name-1" name="name" defaultValue={name} autoComplete="off" onChange={onTeamNameChanged} />
        <TeamNameAlert
          name={name}
        />
      </div>
