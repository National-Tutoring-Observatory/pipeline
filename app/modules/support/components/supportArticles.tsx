...
function SupportArticleList({ supportArticles, onSupportArticleClicked, onSearchClicked }: {
...
function SupportArticleDetail({ article, onBackToSupportArticlesClicked }: {
...
export default function SupportArticles({
  ...
  const article = supportArticles.find(a => a.documentId === selectedDocumentId);
