...
**Users** are individuals who have access to Sandpiper. Each user has a unique account that allows them to create and manage **Projects**, import data, and run analyses. Users are the primary actors in the system, performing all the key tasks.

Users can also be members of one or more **Teams** to collaborate with colleagues on shared research initiatives.

## How to use

Your user account is your gateway to Sandpiper.
