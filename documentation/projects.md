...
A **Project** is the highest level of organization in Sandpiper. It acts as a central folder or workspace where you can store and manage all the components related to a specific research initiative or task. This includes your raw tutoring data (**Sessions** and **Files**), the **Prompts** you've created, and the results of your analysis (**Runs**).
...
The process of using projects in Sandpiper involves creating a new project, adding your data and prompts, and then running your analysis within that project.
